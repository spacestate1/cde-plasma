...
CdeButton::CdeButton(KDecoration2::DecorationButtonType type,
                     KDecoration2::Decoration *decoration,
                     QObject *parent)
    : KDecoration2::DecorationButton(type, QPointer<KDecoration2::Decoration>(decoration), parent)
{
}

void CdeButton::paint(QPainter *painter, const QRect &repaintArea)
{
    ...
    if (type() == KDecoration2::DecorationButtonType::Close && (hovered || pressed)) {
...
{
    return qobject_cast<CdeDecoration *>(decoration().data());
}
