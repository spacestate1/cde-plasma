...
if(CMAKE_INSTALL_COMPONENT STREQUAL "cde_qt_style" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/usr/lib/qt6/plugins/styles/cde_qt_style.so" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/lib/qt6/plugins/styles/cde_qt_style.so"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/lib/qt6/plugins/styles/cde_qt_style.so")
  ...
  if(EXISTS "$ENV{DESTDIR}/usr/lib/qt6/plugins/styles/cde_qt_style.so" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/lib/qt6/plugins/styles/cde_qt_style.so")
    endif()
  endif()
endif()
